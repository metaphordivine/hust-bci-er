...
CLEAN_SCORE_ROUTES = [
    ...
    ScoreRoute(
        ...
        True,
        "sparse query-context fusion using fixed-crop CAR FBSTCNet as query with low-weight no-EA eps3e4 m-conn FBSTCNet, SRFNet whitening eps3e4, and Conformer context",
        method="query_context",
        query_component="fixed_crop_car_fbstcnet_component",
        context_components=(
            "fixed_crop_whitening_eps3e4_fbstcnet_m_conn_component",
    ...
    ScoreRoute(
        ...
        True,
        "boundary-only repair fusion that keeps fixed-crop CAR FBSTCNet scores when top-4 margin is high and adds no-EA eps3e4 m-conn/SRFNet/Conformer context only near the decision boundary",
        method="margin_adaptive_query_context",
        query_component="fixed_crop_car_fbstcnet_component",
        context_components=(
            "fixed_crop_whitening_eps3e4_fbstcnet_m_conn_component",
        ...
        alpha=0.0,
        adaptive_alpha_max=0.25,
        temperature=1.00,
        margin_low=0.15,
        margin_high=0.85,
    ),
    ScoreRoute(
        "car_fbstcnet_hardness_router_noea_mconn_srfnet_whitening_conformer_fusion",
        "car_fbstcnet_hardness_router_noea_mconn_srfnet_whitening_conformer_fusion",
        (
            "fixed_crop_car_fbstcnet_component",
            "fixed_crop_whitening_eps3e4_fbstcnet_m_conn_component",
        ...
        True,
        "cohort-blind hardness router using CAR FBSTCNet as query and increasing no-EA m-conn/SRFNet/Conformer context weight when query margin is low or components disagree",
        method="hardness_router_query_context",
        query_component="fixed_crop_car_fbstcnet_component",
        context_components=(
            "fixed_crop_whitening_eps3e4_fbstcnet_m_conn_component",
            "srfnet_long_component",
