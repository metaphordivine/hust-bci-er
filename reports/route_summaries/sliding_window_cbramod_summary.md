...
decision: PASS
reproduce: python scripts/repo_doctor.py experiment --route configs/routes/models/sliding_window_cbramod.yaml --run outputs/candidate_all_models/20260516_132255/sliding_window_cbramod --gate candidate
dataset: train_v1
