# fixed_crop_pure_deformer_lite Summary

route_id: fixed_crop_pure_deformer_lite
route_status: IDEA
...
decision: HOLD
reproduce: python scripts/repo_doctor.py experiment --route configs/routes/models/fixed_crop_pure_deformer_lite.yaml --run outputs/protocol_p1_full_5lane_20260518_1225/fixed_crop_pure_deformer_lite --gate candidate
dataset: train_v1
