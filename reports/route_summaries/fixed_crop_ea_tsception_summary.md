# fixed_crop_ea_tsception Summary

route_id: fixed_crop_ea_tsception
route_status: IDEA
...
decision: HOLD
reproduce: python scripts/repo_doctor.py experiment --route configs/routes/models/fixed_crop_ea_tsception.yaml --run outputs/protocol_p1_full_5lane_20260518_1225/fixed_crop_ea_tsception --gate candidate
dataset: train_v1
