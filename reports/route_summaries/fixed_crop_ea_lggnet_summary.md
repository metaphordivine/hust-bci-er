# fixed_crop_ea_lggnet Summary

route_id: fixed_crop_ea_lggnet
route_status: IDEA
...
decision: HOLD
reproduce: python scripts/repo_doctor.py experiment --route configs/routes/models/fixed_crop_ea_lggnet.yaml --run outputs/protocol_p1_full_5lane_20260518_1225/fixed_crop_ea_lggnet --gate candidate
dataset: train_v1
