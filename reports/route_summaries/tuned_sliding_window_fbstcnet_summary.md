# tuned_sliding_window_fbstcnet Summary

route_id: tuned_sliding_window_fbstcnet
route_status: IDEA
...
decision: HOLD
reproduce: python scripts/repo_doctor.py experiment --route configs/routes/models/tuned_sliding_window_fbstcnet.yaml --run outputs/protocol_p1_full_5lane_20260518_1225/tuned_sliding_window_fbstcnet --gate candidate
dataset: train_v1
