# fixed_crop_ea_tsception_train_aug Summary

route_id: fixed_crop_ea_tsception_train_aug
route_status: IDEA
...
decision: HOLD
reproduce: python scripts/repo_doctor.py experiment --route configs/routes/models/fixed_crop_ea_tsception_train_aug.yaml --run outputs/protocol_p1_full_5lane_20260518_1225/fixed_crop_ea_tsception_train_aug --gate candidate
dataset: train_v1
