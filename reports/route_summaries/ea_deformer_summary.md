...
decision: PASS
reproduce: python scripts/repo_doctor.py experiment --route configs/routes/models/ea_deformer.yaml --run outputs/candidate_all_models/20260516_132255/ea_deformer --gate candidate
dataset: train_v1
